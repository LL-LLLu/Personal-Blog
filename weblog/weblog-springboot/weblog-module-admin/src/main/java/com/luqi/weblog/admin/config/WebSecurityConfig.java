...
import com.luqi.weblog.jwt.config.JwtAuthenticationSecurityConfig;
import com.luqi.weblog.jwt.filter.TokenAuthenticationFilter;
import com.luqi.weblog.jwt.handler.RestAccessDeniedHandler;
import com.luqi.weblog.jwt.handler.RestAuthenticationEntryPoint;
 ...
 * @description: Spring Security config class
 **/
@Configuration
@EnableWebSecurity
