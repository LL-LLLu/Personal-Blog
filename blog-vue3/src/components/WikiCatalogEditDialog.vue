    ...
    >
      ...
      >
        ...
        >
          <svg
            data-accordion-icon
            class="w-3 h-3 mr-2 rotate-180 shrink-0"
            aria-hidden="true"
          ...
          >
            <el-input
              ...
              placeholder="Please enter catalog title"
              clearable
        ...
        >
          ...
          >
            ...
            >
              ...
              <span class="w-full">
                <span
                  v-if="!childCatalog.editing"
                  class="flex items-center"
                  v-html="childCatalog.title"
                />
                <span v-else>
                  <el-input
                    v-model="childCatalog.title"
                    autofocus="true"
                    placeholder="Please enter catalog title"
                    clearable
              ...
              <!-- Rename -->
              <span
                class="hover:bg-gray-200 rounded py-2 px-2 ml-2 mr-2 cursor-pointer"
              ...
              >
                <span
                  class="hover:bg-gray-200 rounded py-2 px-2 cursor-pointer"
