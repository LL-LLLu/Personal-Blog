<template>
  ...
  <div class="bg-white dark:bg-gray-900 h-[64px] flex pr-4 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50 w-full">
    <!-- Sidebar collapse/expand -->
    <div
      class="w-[42px] h-[64px] cursor-pointer flex items-center justify-center text-gray-700 dark:text-gray-300 flex-shrink-0"
    ...
    <!-- Right container -->
    <div class="ml-auto flex items-center overflow-x-auto no-scrollbar">
      ...
      >
        <div
          class="w-[42px] h-[64px] cursor-pointer flex items-center justify-center flex-shrink-0"
      ...
      >
        <div
          class="w-[42px] h-[64px] cursor-pointer flex items-center justify-center text-gray-700 dark:text-gray-300 mr-2 flex-shrink-0"
          @click="toggle"
        >
          <el-icon>
