<template>
    <div class="w-full py-3 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 transition-all duration-300">
        ...
        <div class="flex items-center justify-between w-full px-2 mb-2">
            <h3 class="text-base font-semibold text-gray-900 dark:text-white">Blogger Info</h3>
        ...
        <div class="flex flex-col items-center" v-show="!isMinimized">
            <!-- Blogger avatar -->
            <div class="relative mb-3">
                <img class="w-12 h-12 rounded-full shadow"
                    :src="blogSettingsStore.blogSettings.avatar"/>    
                <span
                    class="bottom-0 left-8 absolute w-3 h-3 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
            </div>
            
            <!-- Blogger nickname -->
            <h5 class="mb-2 text-lg font-medium text-gray-900 dark:text-white">{{ blogSettingsStore.blogSettings.author }}</h5>
            
            <!-- Introduction -->
            <span class="mb-4 text-sm text-gray-500 dark:text-gray-400 text-center px-2" data-tooltip-target="introduction-tooltip-bottom"
            ...
            <div class="w-full mb-4 space-y-2">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-baseline gap-1.5 mb-0.5">
                                <CountTo :value="statisticsInfo.articleTotalCount" 
                                    customClass="text-base sm:text-lg font-bold text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors"></CountTo>
                                <div class="w-1 h-1 bg-blue-500 rounded-full animate-pulse flex-shrink-0"></div>
                            </div>
                            <div class="text-[9px] sm:text-[10px] font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide truncate">Articles</div>
                        </div>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-baseline gap-1.5 mb-0.5">
                                <CountTo :value="statisticsInfo.categoryTotalCount" 
                                    customClass="text-base sm:text-lg font-bold text-emerald-600 dark:text-emerald-400 group-hover:text-emerald-700 dark:group-hover:text-emerald-300 transition-colors"></CountTo>
                                <div class="w-1 h-1 bg-emerald-500 rounded-full animate-pulse flex-shrink-0"></div>
                            </div>
                            <div class="text-[9px] sm:text-[10px] font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide truncate">Categories</div>
                        </div>
                        <div class="opacity-40 group-hover:opacity-70 transition-opacity flex-shrink-0 ml-2">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-baseline gap-1.5 mb-0.5">
                                <CountTo :value="statisticsInfo.tagTotalCount" 
                                    customClass="text-base sm:text-lg font-bold text-purple-600 dark:text-purple-400 group-hover:text-purple-700 dark:group-hover:text-purple-300 transition-colors"></CountTo>
                                <div class="w-1 h-1 bg-purple-500 rounded-full animate-pulse flex-shrink-0"></div>
                            </div>
                            <div class="text-[9px] sm:text-[10px] font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide truncate">Tags</div>
                        </div>
                        <div class="opacity-40 group-hover:opacity-70 transition-opacity flex-shrink-0 ml-2">
                ...
                <div class="stats-card bg-gradient-to-r from-amber-50/80 to-orange-50/80 dark:from-amber-900/10 dark:to-orange-900/10 
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-baseline gap-1.5 mb-0.5">
                                <CountTo :value="statisticsInfo.pvTotalCount" 
                                    customClass="text-base sm:text-lg font-bold text-amber-600 dark:text-amber-400 transition-colors"></CountTo>
                                <div class="w-1 h-1 bg-amber-500 rounded-full animate-pulse flex-shrink-0"></div>
                            </div>
                            <div class="text-[9px] sm:text-[10px] font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide truncate">Total Visits</div>
                        </div>
            ...
            <!-- Third-party platform homepage links (like GitHub, etc.) -->
            <div class="flex justify-center gap-1.5">
                ...
                <svg @click="jump(blogSettingsStore.blogSettings.githubHomepage)" v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662" data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon mt-3 w-6 h-6 hover:scale-110" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
