    ...
    <nav class="bg-white border-gray-200 border-b dark:border-gray-800 dark:bg-[#0d1117]">
      <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center md:order-2">
          ...
          <button
            class="ml-1 mr-4 vt-switch vt-switch-appearance"
            type="button"
            role="switch"
          ...
          >
            ...
            <span class="mr-3">Search articles ...</span>
          ...
          <div
            v-if="!isLogined"
            class="text-gray-900 ml-1 mr-1 hover:text-gray-700 dark:text-white"
            @click="$router.push('/login')"
          >
            Login
          </div>
          <!-- Already logged in, show user avatar -->
          <button
            v-else
            id="dropdownDefaultButton"
            data-dropdown-toggle="dropdown"
            class="text-white ml-2 mr-2 md:mr-0 focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm text-center inline-flex items-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
            type="button"
          >
            <!-- User login avatar -->
            <img
        ...
        >
          ...
          >
            ...
            <span class="mr-3 grow text-left">Searching Articles...</span>
          ...
          >
            <li>
              <a
                :class="[currPath == '/' ? 'text-gray-900 border-b-2 border-gray-800 pb-1 font-semibold' : 'text-gray-600']"
                class="block py-2 pl-3 pr-4 md:bg-transparent md:p-0 md:dark:text-gray-300 hover:text-gray-900 transition-colors duration-200 cursor-pointer"
                aria-current="page"
                @click="router.push('/')"
              >Home</a>
            </li>
            <li>
              <a
                :class="[currPath == '/category/list' || currPath.includes('/category/article/list') ? 'text-gray-900 border-b-2 border-gray-800 pb-1 font-semibold' : 'text-gray-600']"
                class="block py-2 pl-3 pr-4 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-900 md:p-0 md:dark:hover:text-gray-300 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-200 cursor-pointer"
                @click="router.push('/category/list')"
              >Category</a>
            </li>
            <li>
              <a
                :class="[currPath == '/tag/list' || currPath.includes('/tag/article/list') ? 'text-gray-900 border-b-2 border-gray-800 pb-1 font-semibold' : 'text-gray-600']"
            ...
            <li>
              <a
                :class="[currPath.startsWith('/wiki') ? 'text-blue-600 md:border-b-2 md:border-blue-600 dark:text-blue-500 dark:md:border-blue-600' : 'text-gray-900 dark:text-white']"
                class="block py-2 pl-3 pr-4 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-200 cursor-pointer"
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
          ...
          <form class="w-full mr-2">
            ...
            <div class="relative">
              <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                ...
                >
                  <svg
                    aria-hidden="true"
                    class="w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600"
                    viewBox="0 0 100 101"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <input
                ...
                v-model="searchWord"
                type="search"
                class="block w-full py-3 ps-10 pe-12 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-gray-500 focus:border-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
              ...
              <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                <button
                  type="button"
                  :class="[fuzzySearch || wildcardSearch ? 'text-gray-800 dark:text-gray-300' : 'text-gray-400 dark:text-gray-500']" 
                  class="hover:text-gray-800 focus:outline-none transition-colors duration-200"
                ...
                >
                  ...
                  >
                    <path
                      ...
                      clip-rule="evenodd"
                    />
                    <!-- Different indicators for different search modes -->
                    <circle
                      v-if="fuzzySearch"
                      cx="8"
                      cy="8"
            ...
            <!-- Search mode options -->
            <div
              v-if="fuzzySearch || wildcardSearch"
              class="mt-2 p-2 bg-gray-100 dark:bg-gray-600 rounded-lg"
            >
              ...
              >
                <label class="text-gray-700 dark:text-gray-300">Edit Distance:</label>
                <select
                  v-model="maxEdits"
                  class="text-xs bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-500 rounded px-2 py-1"
                >
                  <option value="1">
                    1 (Strict)
                  </option>
              ...
              <div class="flex items-center justify-between text-xs">
                <label class="text-gray-700 dark:text-gray-300">Search Mode:</label>
                <div class="flex space-x-2">
                  <button
                    type="button"
                    :class="[!fuzzySearch && !wildcardSearch ? 'bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-gray-200' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400']"
                  ...
                  <button
                    type="button"
                    :class="[fuzzySearch ? 'bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-gray-200' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400']"
                    class="px-2 py-1 rounded text-xs transition-colors"
                  ...
                  <button
                    type="button"
                    :class="[wildcardSearch ? 'bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-gray-200' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400']"
                    class="px-2 py-1 rounded text-xs transition-colors"
                    @click="setSearchMode('wildcard')"
                  >
                    Prefix/Suffix
                  </button>
                </div>
              ...
              >
                <div class="flex items-start">
                  <svg
                    class="w-3 h-3 mt-0.5 mr-1 text-gray-600"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                  ...
                  <div>
                    <strong>Wildcard Search:</strong> Automatically finds articles by prefix/suffix matching.<br>
                    <span class="text-gray-500">Examples: "java" matches "javascript", "javabeans", "java-tutorial"</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="p-4 md:p-5 space-y-4">
          <div v-if="searchArticles && searchArticles.length > 0">
            ...
            <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
              ...
              >
                ...
                >
                  <img
                    class="w-24 h-full mb-3 mr-3 rounded-lg sm:mb-0"
                    :src="article.cover"
                  >
            ...
            <div class="flex mt-7">
              <a
                v-if="current > 1"
                class="flex items-center justify-center px-3 h-8 me-3 text-xs font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white cursor-pointer" 
                @click="prePage"
              >
                <svg
              ...
              <a
                v-if="current < pages"
                class="flex ml-auto items-center justify-center px-3 h-8 text-xs font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white cursor-pointer" 
                @click="nextPage"
              >
                <svg
                  class="w-3 h-3 rtl:rotate-180"
          ...
          <div
            v-else
            class="flex items-center justify-center flex-col mb-10"
          >
            <svg
              class="w-50 h-50"
              height="200"
              ...
              template-width="1287"
              version="1.1"
              viewBox="0 0 1287 1000"
              width="1287"
              xmlns="http://www.w3.org/2000/svg"
xmlns:xlink="http://www.w3.org/1999/xlink"
            ><defs node-id="31" /><path
              ...
              node-id="33"
              stroke="none"
              target-height="416.60968"
              target-width="631.0967"
              target-x="330.46844"
              target-y="133.7226"
            /><path
              ...
              node-id="35"
              stroke="none"
              target-height="529.05273"
              target-width="715.2872"
              target-x="285.85657"
              target-y="319.95316"
            /><path
              ...
              node-id="37"
              stroke="none"
              target-height="151.01958"
              target-width="207.19415"
              target-x="754.64343"
              target-y="208.39409"
            /><path
              ...
              node-id="39"
              stroke="none"
              target-height="106.95955"
              target-width="63.86621"
              target-x="448.91815"
              target-y="166.34673"
            /><path
              ...
              node-id="41"
              stroke="none"
              target-height="152.67892"
              target-width="110.29831"
              target-x="477.93912"
              target-y="305.46857"
            /><path
              ...
              node-id="43"
              stroke="none"
              target-height="85.87799"
              target-width="141.29077"
              target-x="819.6579"
              target-y="434.9206"
            /><path
              ...
              node-id="45"
              stroke="none"
              target-height="31.787598"
              target-width="75.46402"
              target-x="375.6795"
              target-y="332.91104"
            /><path
              ...
              node-id="47"
              stroke="none"
              target-height="61.05577"
              target-width="56.33368"
              target-x="636.1679"
              target-y="225.02061"
            /><path
              ...
              node-id="49"
              stroke="none"
              target-height="69.63153"
              target-width="92.84186"
              target-x="599.93427"
              target-y="796.6459"
            /><path
              ...
              node-id="51"
              stroke="none"
              target-height="5.867737"
              target-width="142.73828"
              target-x="586.01874"
              target-y="581.94104"
            /><path
              ...
              node-id="53"
              stroke="none"
              target-height="5.9813232"
              target-width="96.77783"
              target-x="739.5124"
              target-y="618.6565"
            /><path
              ...
              node-id="55"
              stroke="none"
              target-height="11.983459"
              target-width="48.551636"
              target-x="695.44556"
              target-y="662.6782"
            /><path
              ...
              node-id="57"
              stroke="none"
              target-height="11.24588"
              target-width="10.538055"
              target-x="511.2839"
              target-y="279.99405"
            /><path
              ...
              node-id="59"
              stroke="none"
              target-height="61.936462"
              target-width="13.37262"
              target-x="721.2057"
              target-y="429.77798"
            /><path
              ...
              node-id="61"
              stroke="none"
              target-height="21.76706"
              target-width="26.746033"
              target-x="576.3489"
              target-y="430.46957"
            /><path
              ...
              node-id="63"
              stroke="none"
              target-height="17.049988"
              target-width="29.152405"
              target-x="622.60175"
              target-y="491.46555"
            /><path
              ...
              node-id="65"
              stroke="none"
              target-height="14.190033"
              target-width="7.7456055"
              target-x="595.44745"
              target-y="455.3441"
            /><path
            ...
            /><path
              ...
              node-id="69"
              stroke="none"
              target-height="36.994446"
              target-width="26.41394"
              target-x="827.99243"
              target-y="263.5507"
            /><path
              ...
              node-id="71"
              stroke="none"
              target-height="39.505035"
              target-width="25.45996"
              target-x="803.11395"
              target-y="265.16733"
            /><path
              ...
              node-id="73"
              stroke="none"
              target-height="42.27545"
              target-width="19.625977"
              target-x="857.5324"
              target-y="262.0243"
            /><path
              ...
              node-id="75"
              stroke="none"
              target-height="39.37744"
              target-width="25.278198"
              target-x="899.28253"
              target-y="259.80588"
            /><path
              ...
              node-id="77"
              stroke="none"
              target-height="37.827454"
              target-width="21.341797"
              target-x="877.06213"
              target-y="261.62155"
            /></svg>
        ...
        <div class="p-4 md:p-5 border-t text-xs flex items-center text-gray-400">
          ...
          <span class="ml-auto">Powered by&nbsp;<a
            href="https://lucene.apache.org/"
            target="_blank"
            class="underline"
          >Apache Lucene</a>&nbsp;full-text search engine</span>
        </div>
      </div>
    </div>
  </div>
  ...
  >
    ...
    <div class="grow transition-all duration-300">
      ...
      >
        <div
          v-for="(catalog, index) in props.catalogs"
          :key="index"
        >
          ...
          <!-- Level 2 Catalog -->
          <ul
            :id="'drawer-accordion-flush-body-' + catalog.id"
            class="hidden"
            :aria-labelledby="'drawer-accordion-flush-heading-' + catalog.id"
          >
            <!-- Level 2 Catalog Title -->
            <li
              v-for="(childCatalog, index2) in catalog.children"
              :key="index2"
              class="flex items-center ps-10 py-2 pe-3 rounded-lg cursor-pointer 
                                    dark:text-gray-400"
...
// Wiki Drawer Reference
const wikiDrawer = ref(null)
// Wiki Drawer Expand State
...
const drawerOptions = {
    ...
    edgeOffset: '',
    backdropClasses:
        'bg-gray-900/50 dark:bg-gray-950/50 fixed inset-0 z-[19] block lg:hidden',
    onHide: () => {
...
const modalOptions = {
    placement: 'top-center', // Modal position
    backdrop: 'dynamic',
    backdropClasses:
...
onBeforeUnmount(() => {
    // Remove event listener before component unmount to prevent memory leak
...
const handleKeyDown = (event) => {
    ...
    if (event.ctrlKey && event.key === 'k') {
        // Prevent browser default search
...
// Wildcard search toggle
const wildcardSearch = ref(false)
...
function renderSearchArticles(data) {
    ...
    const searchData = {
        ...
        maxEdits: maxEdits.value,
        wildcardSearch: wildcardSearch.value
    }
    
    getArticleSearchPageList(searchData).then(res => {
        console.log(res)
        if (res.success) {
...
const toggleSearchOptions = () => {
    // If no special search mode is active, enable fuzzy search
    if (!fuzzySearch.value && !wildcardSearch.value) {
        fuzzySearch.value = true
    } else {
        // If any mode is active, toggle to next mode or turn off
        if (fuzzySearch.value) {
            fuzzySearch.value = false
            wildcardSearch.value = true
        } else if (wildcardSearch.value) {
            wildcardSearch.value = false
        }
    }
    
    // Re-search if there's an active search term
...
const setSearchMode = (mode) => {
    ...
    // mode === 'exact' sets both to false (default above)
...
// Get current search mode title
const getSearchModeTitle = () => {
    if (fuzzySearch.value) {
        return 'Fuzzy search enabled - tolerates typos'
    } else if (wildcardSearch.value) {
        return 'Wildcard search enabled - matches prefix/suffix'
    } else {
        return 'Click to enable advanced search modes'
    }
}
