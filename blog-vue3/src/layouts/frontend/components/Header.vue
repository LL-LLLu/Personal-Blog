        ...
        <nav class="bg-white border-gray-200 border-b dark:border-gray-800 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex items-center md:order-2">
                    ...
                    <button @click="toggleDark()" class="ml-1 mr-4 vt-switch vt-switch-appearance" type="button" role="switch" aria-label="Toggle dark mode"
                        aria-checked="false"><span class="vt-switch-check"><span
                    ...
                    <!-- Login -->
                    <div class="text-gray-900 ml-1 mr-1 hover:text-gray-700 dark:text-white" v-if="!isLogined"
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    ...
                    <ul
                        ...
                        <li>
                            <a @click="router.push('/')" :class="[currPath == '/' ? 'text-gray-900 border-b-2 border-gray-800 pb-1 font-semibold' : 'text-gray-600']"
                        ...
                        <li>
                            <a @click="router.push('/category/list')"
                                ...
                                class="block py-2 pl-3 pr-4 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-900 md:p-0 md:dark:hover:text-gray-300 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-200 cursor-pointer">Category</a>
                        </li>
                        <li>
                            <a @click="router.push('/tag/list')"
                                ...
                                class="block py-2 pl-3 pr-4 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-900 md:p-0 dark:text-white md:dark:hover:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-200 cursor-pointer">Tags</a>
                        </li>
                        <li>
                            <a @click="router.push('/archive/list')"
                                ...
                                class="block py-2 pl-3 pr-4 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-900 md:p-0 dark:text-white md:dark:hover:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-200 cursor-pointer">Archive</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to log out?
                    </h3>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form class="w-full mr-2">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                <button type="button" @click="toggleSearchOptions" 
                                    ...
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <circle v-if="fuzzySearch" cx="8" cy="8" r="2" fill="white"></circle>
                                        <rect v-else-if="wildcardSearch" x="6" y="6" width="4" height="4" fill="white" rx="1"></rect>
                                    </svg>
                                </button>
                            </div>
                        </div>
                        ...
                        <!-- Search mode options -->
                        <div v-if="fuzzySearch || wildcardSearch" class="mt-2 p-2 bg-gray-100 dark:bg-gray-600 rounded-lg">
                            <!-- Fuzzy search options -->
                            <div v-if="fuzzySearch" class="flex items-center justify-between text-xs mb-2">
                                <label class="text-gray-700 dark:text-gray-300">Edit Distance:</label>
                                <select v-model="maxEdits" class="text-xs bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-500 rounded px-2 py-1">
                            ...
                            <div class="flex items-center justify-between text-xs">
                                ...
                                <div class="flex space-x-2">
                                    <button type="button" @click="setSearchMode('exact')"
                                    ...
                                    <button type="button" @click="setSearchMode('fuzzy')"
                                    ...
                                    <button type="button" @click="setSearchMode('wildcard')"
                            ...
                            <div v-if="wildcardSearch" class="mt-2 text-xs text-gray-600 dark:text-gray-400">
                                <div class="flex items-start">
                                    <svg class="w-3 h-3 mt-0.5 mr-1 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    ...
                    <div v-else class="flex items-center justify-center flex-col mb-10">
                        ...
                        <p class="text-gray-600 text-sm">No results found, try a different search term~</p>
                    </div>  
                </div>
                <!-- Modal footer -->
                <div class="p-4 md:p-5 border-t text-xs flex items-center text-gray-400">
                    ...
                    <span class="ml-auto">Powered by&nbsp;<a href="https://lucene.apache.org/" target="_blank"
                            class="underline">Apache Lucene</a>&nbsp;full-text search engine</span>
                </div>
            </div>
        </div>
    </div>
