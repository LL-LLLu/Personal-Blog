<template>
  <div class="main min-h-screen flex flex-col">
    <WikiHeader :catalogs="catalogs" />
    <main class="grow container max-w-screen-3xl mx-auto px-4 sm:px-6 md:px-8 py-4">
      <!-- 左边栏 -->
      <div
        class="transition-all duration-300 hidden lg:block fixed inset-0 top-[5.5rem]
      ...
      >
        <div class="flex">
          ...
          >
            <div
              id="left-toc-sidebar"
              class="left-toc-sidebar top-[5.5rem]"
            >
              <span
      ...
      >
        <div class="max-w-3xl mx-auto xl:max-w-none xl:ml-0 xl:mr-[15.5rem] xl:pr-16">
          ...
          <article>
            <!-- 文章标题、Meta 信息 -->
            <div class="mt-5">
              <h1 class="font-bold text-3xl md:text-4xl mb-5 dark:text-gray-400">
                {{ article.title }}
              </h1>
              <div
                class="flex gap-3 md:gap-6 text-gray-400 items-center text-sm pb-3
            ...
            >
              ...
              <div class="basis-1/2">
                ...
                >
                  ...
                  <div v-html="preNext.preArticle.articleTitle" />
                </a>
              </div>
              ...
              <div class="basis-1/2">
                ...
                >
                  ...
                  <div v-html="preNext.nextArticle.articleTitle" />
                </a>
              </div>
            </nav>
      ...
      <!-- 右边栏 -->
      <div
        class="fixed top-[3.8125rem] bottom-0 right-[max(0px,calc(50%-50rem))]
...
const goCategoryArticleListPage = (categoryId, categoryName) => {
    router.push({ path: '/category/article/list', query: { id: categoryId, name: categoryName } })
}
