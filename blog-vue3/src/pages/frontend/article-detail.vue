          ...
          <article>
            ...
            <div :class="{ 'dark': isDark }">
              ...
              <div class="flex items-center text-gray-500 text-sm mt-5">
                <svg
                  class="icon inline-block w-4 h-4 mr-1"
                  viewBox="0 0 1024 1024"
                  version="1.1"
                  xmlns="http://www.w3.org/2000/svg"
                  p-id="7701"
...
function refreshArticleDetail(articleId) {
    getArticleDetail(route.params.articleId).then((res) => {
        // Article doesn't exist (error code 20010)
        if (!res.success && res.errorCode == '20010') {
            // Manually navigate to 404 page
            ...
            preElements.forEach(preElement => {
                ...
                if (firstCode) {
                    ...
                    copyBtn.addEventListener('click', () => {
                        ...
                        // Remove copied style after 1.5 seconds
                        setTimeout(() => {
...
/* Set margin-bottom of last p tag in blockquote to 0 */
...
.article-content :deep(img:focus) {
...
/* Dark mode styles */
/* h1, h2, h3, h4, h5, h6 heading styles - dark mode */
...
/* p paragraph styles - dark mode */
:deep(.dark .article-content p) {
    color: #9e9e9e;
}

/* blockquote quote styles - dark mode */
