    ...
    <div class="grid grid-cols-4 gap-7">
      ...
      <div class="col-span-4 md:col-span-3 mb-3">
        ...
        >
          ...
          <div class="flex flex-wrap gap-3">
            <a
              ...
              :key="index"
              :class="[route.query.name == tag.name ? 'bg-sky-100 hover:bg-sky-200 dark:bg-sky-900 dark:hover:bg-sky-800' : 'hover:bg-gray-100 dark:hover:bg-gray-700']"
        ...
        <div class="p-5 mb-4 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
          ...
          <!-- No articles under this tag tip, flex layout with centered content -->
          <div
            v-else
          ...
          >
            ...
            <p class="mt-2 mb-16 text-gray-400 dark:text-gray-500">
              There is no article under this tag~
            </p>
          </div>
        </div>
...
function getTagArticles(currentNo) {
    // Check if pagination navigation is valid
