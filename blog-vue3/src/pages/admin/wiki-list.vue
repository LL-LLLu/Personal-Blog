          ...
          <template #default="scope">
            ...
            >
              <el-button
                ...
                :icon="Tickets"
                circle
                @click="showWikiCatalogEditDialog(scope.row.id)"
              />
            </el-tooltip>
            ...
            >
              <el-button
                ...
                :icon="View"
                circle
                @click="goWikiDetailPage(scope.row.id)"
              />
            </el-tooltip>
    ...
    >
      ...
      >
        ...
        >
          <el-input
            v-model="form.title"
            placeholder="Please enter wiki title"
            maxlength="20"
            show-word-limit
            clearable
          />
        ...
        >
          ...
          <el-input
            ...
            show-word-limit
            type="textarea"
            placeholder="Please enter wiki summary"
            clearable
          />
        </el-form-item>
      </el-form>
